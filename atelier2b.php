...
if(isset($_GET['id_utilisateur']) AND $_GET['id_utilisateur'] > 0){
    ...
    $reqdroit = $bdd->prepare('SELECT * FROM H_RACI WHERE id_utilisateur = ? AND id_projet = ? AND id_atelier="2.b"');
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top fixed-top shadow" id="barre_info">
          ...
          <div id="top_bar_3" class="top_bar_name_3">Activité 2.b - Évaluer les couples sources de risque/objectifs visés</div>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="row perso_no_margin">
                    ...
                    <div class="card-header perso_header_right col-6 col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                      <a class="download_table_button" id="button_download_evaluation_SROV">
...
>>>>>>> origin/Carlos
  ...
  <?php if($userinfo['type_compte']=='Administrateur Logiciel'||$userdroit_chef_de_projet['id_utilisateur']==$getid){    
    ...
    ?>
                <script src="content/js/atelier/atelier2b_no_modification.js"></script>
    <?php
            }
        }        
    ?>
