  ...
  (function($) {
      ...
      $.fn.Tabledit = function(options) {
          ...
          var defaults = {
              ...
              inputClass: 'form-control input-sm perso_textarea',
              toolbarClass: 'btn-toolbar perso_toolbar',
                      ...
                      for (var i = 0; i < settings.columns.editable.length; i++) {
                          ...
                          $td.each(function () {
                              ...
                              if (typeof settings.columns.editable[i][2] !== 'undefined') {
                                  ...
                                  var input = '<select class="tabledit-input width_select ' + settings.inputClass + '" name="' + settings.columns.editable[i][1] + '" style="display: none;" disabled>';
                      ...
                      for (var i = 0; i < settings.columns.dateeditable.length; i++) {
                        ...
                        //   var $td = $('#editable_table_ecart tbody td:nth-child(8)');
                          ...
                          $td.each(function () {
                              ...
                              // Check if exists the third parameter of dateeditable array.
                              if (typeof settings.columns.dateeditable[i][2] !== 'undefined') {
                                  // Create select element.
                                  var input = '<select class="tabledit-input ' + settings.inputClass + '" name="' + settings.columns.dateeditable[i][1] + '" style="display: none;" disabled>';


                                  // Create options for select element.
                                  $.each(jQuery.parseJSON(settings.columns.dateeditable[i][2]), function (index, value) {
                                      if (text === value) {
                                          input += '<option value="' + index + '" selected>' + value + '</option>';
                                      } else {
                                          input += '<option value="' + index + '">' + value + '</option>';
                                  ...
                                  // Create text input element.
                                  var input = '<input class="tabledit-input ' + settings.inputClass + '" type="date" name="' + settings.columns.dateeditable[i][1] + '" value="' + $(this).text() + '" style="display: none;" disabled>';
                                //   var input = '<textarea class="tabledit-input ' + settings.inputClass + '" rows="1" type="text" name="' + settings.columns.dateeditable[i][1] + '" style="display: none;" disabled>' + $(this).text() + '</textarea>';
                              }
