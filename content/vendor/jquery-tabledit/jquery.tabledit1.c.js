    ...
    var Draw = {
      columns: {
        identifier: function () {
          ...
          if (settings.hideIdentifier) {//true
          ...
          var $td = $table.find('tbody td:nth-child(' + (parseInt(settings.columns.identifier[0]) + 1) + ')');//colonne id (cachée)
        ...
        editable: function () {
          for (var i = 0; i < settings.columns.editable.length; i++) {//pour toute les cases éditable d'une ligne
