...
$query_SROV = "SELECT description_source_de_risque, objectif_vise, pertinence, choix_source_de_risque FROM P_SROV WHERE id_projet = $getid_projet ORDER BY id_source_de_risque";
