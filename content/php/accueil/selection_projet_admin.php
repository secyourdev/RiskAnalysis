...
$search_projet_version = $bdd->prepare("SELECT DISTINCT id_version, num_version FROM ZC_version INNER JOIN ZD_projet_gen ON ZC_version.id_projet = ZD_projet_gen.id_projet_desc_current ORDER BY ZC_version.id_projet ASC");
