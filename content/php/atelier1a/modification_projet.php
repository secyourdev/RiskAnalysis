...
if(isset($_POST['objectif_atteindre'])){
    ...
    $update_projet = $bdd->prepare("UPDATE projet SET objectif_projet = ?");
...
if(isset($_POST['respo_acceptation_risque'])){
    ...
    $update_projet = $bdd->prepare("UPDATE projet SET responsable_risque_residuel = ?");
...
if(isset($_POST['radio_gravite'])){
    ...
    $update_projet = $bdd->prepare("UPDATE projet SET valeur_max_gravite = ?");
...
if(isset($_POST['cadre_temporel'])){
    ...
    $update_projet = $bdd->prepare("UPDATE projet SET cadre_temporel = ?");
