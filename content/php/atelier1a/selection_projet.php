...
if($resultat[0]!=null){
    ...
    $search_projet = $bdd->prepare("SELECT F_projet.id_projet, F_projet.nom_projet, F_projet.objectif_projet, F_projet.cadre_temporel, F_projet.responsable_risque_residuel FROM F_projet WHERE id_projet=?");
} 
