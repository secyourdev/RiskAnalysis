...
$query1 = "SELECT scenario_strategique.id_scenario_strategique, nom_scenario_strategique, description_source_de_risque, objectif_vise, nom_evenement_redoute, id_risque, chemin_d_attaque_strategique, niveau_de_gravite FROM scenario_strategique 
...
$query2 = "SELECT * FROM scenario_operationnel NATURAL JOIN chemin_d_attaque_strategique";
...
<!-- faire une query préparée pour afficher le tableau des modes opératoires
elle sera initialisée avec le scénario opérationnel. -->