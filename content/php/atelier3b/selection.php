...
$query_id_source_de_risque = "SELECT id_source_de_risque, profil_de_l_attaquant_source_de_risque, objectif_vise FROM P_SROV WHERE id_projet = $getid_projet ORDER BY id_source_de_risque ASC";
