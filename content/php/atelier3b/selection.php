...
FROM S_scenario_strategique, T_chemin_d_attaque_strategique, UA_ER, M_evenement_redoute, R_partie_prenante
WHERE T_chemin_d_attaque_strategique.id_projet = R_partie_prenante.id_projet
