...
// if (!preg_match("/^[a-zA-Z0-9éèàêâùïüëçÀÂÉÈÊËÏÙÜ\s\-.:,'\"–]{0,100}$/", $nom_risque_residuelle)) {
//   $results["error"] = true;
//   $_SESSION['message_error'] = "Type du nom_risque_residuelle invalide";
// }

// // Verification du description_risque_residuelle
// if (!preg_match("/^[a-zA-Z0-9éèàêâùïüëçÀÂÉÈÊËÏÙÜ\s\-.:,'\"–]{0,100}$/", $description_risque_residuelle)) {
//   $results["error"] = true;
...
// if (!preg_match("/^[a-zA-Z0-9éèàêâùïüëçÀÂÉÈÊËÏÙÜ\s\-.:,'\"–]{0,100}$/", $vraisemblance_residuelle)) {
//   $results["error"] = true;
