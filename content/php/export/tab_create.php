    ...
    $array = mysqli_fetch_all($rq,MYSQLI_NUM);
        ...
        $memory=$array[0][0];
          ...
          /*for($i = -1; $i < $rq_nb; $i ++){*/
            ...
            $table->addCell(1, $first_cells_style)->addText("Scénario opérationnel");
            $table->addCell(1, $first_cells_style)->addText("Vraisemblance");
            $table->addRow();
            }
            else if($memory == $array[$d][0]){
              // print_r($memory);
            ...
            /*else if($memory == $array[$d][0]){
             ...
             for($j = 1; $j<3;$j++){
                 if($d ==-1){
                   ...
                   switch($array[$d][1]){
                     case 1:
                      $table->addCell(1, $cell_style_basic)->addText($array[$d][2]);
                      break;
                     case 2:
                      $table->addCell(1, $cell_style_basic)->addText($array[$d][3]);
                      break;
                     case 3:
                      $table->addCell(1, $cell_style_basic)->addText($array[$d][4]);
                      break;
                     case 4:
