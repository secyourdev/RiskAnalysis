...
$connect = mysqli_connect("mysql-ebios-rm.alwaysdata.net", "ebios-rm", 'hLLFL\bsF|&[8=m8q-$j', "ebios-rm_v15");
...
$query_nom_referentiel = "SELECT nom_referentiel FROM socle_de_securite WHERE id_atelier = '1' AND id_projet = $getid_projet ORDER BY id_socle_securite";
