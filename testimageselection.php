...
// var_dump($result);
$query_scenario_op= "SELECT id_scenario_operationnel, nom_scenario_operationnel FROM U_scenario_operationnel WHERE id_projet = $getid_projet AND id_atelier = '3.b'";
